...
TIMEOUT_SECONDS=300
MAIN_CLASS="org.maxicp.modeling.gc_dimacs.GraphColoring_And_PS"
...
cd ../
CSV_FILE="resultsGC_And_PS.csv"

echo "Results file : $CSV_FILE"
echo "instance,choice,fail,solutions,AND_nodes,completed,exec_time_ms,status" > "experiment/$CSV_FILE"
...
process_root() {
    ...
    while IFS= read -r instance; do
        ...
        echo "$inst_name,$choice,$fail,$sols,$ANode,$completed,$exec_ms,$status" >> "experiment/$CSV_FILE"
