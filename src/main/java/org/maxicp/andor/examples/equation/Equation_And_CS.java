...
import static org.maxicp.andor.Scheme.naiveTreeBuilding;
...
public class Equation_And_CS {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        //DFSearchMini_And_CS dfs = cp.dfSearchMini_And_CS(graph, fiducciaMattheyses(graph,5, false), firstFail());
