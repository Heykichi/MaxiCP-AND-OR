...
public class XCSP3Mini_And_PS extends XCallbacksDecomp {
    ...
    public static XCSP3LoadedInstance load(String filename) throws Exception {
        XCSP3Mini_And_PS xcsp3 = new XCSP3Mini_And_PS();
        try {
    ...
    public static void main(String[] args) throws Exception {
        String instanceName = (args.length > 0) ? args[0] : "minicsp24/Fillomino/Fillomino-mini-5-0_c24.xml";
