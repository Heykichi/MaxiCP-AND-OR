...
public class XCSP3TestCut extends XCallbacksDecomp {
    ...
    public static XCSP3LoadedInstance load(String filename) throws Exception {
        XCSP3TestCut xcsp3 = new XCSP3TestCut();
        try {
    ...
    public static void main(String[] args) throws Exception {
        String instanceName = (args.length > 0) ? args[0] : "minicsp23/AntimagicSquare/AntimagicSquare-04_mini_c23.xml";
        XCSP3LoadedInstance instance = load(instanceName);
        IntExpression[] q = instance.decisionVars();
        System.out.println("var: " + q.length);
    ...
    public static void test_Cut(ConstraintGraph graph){
