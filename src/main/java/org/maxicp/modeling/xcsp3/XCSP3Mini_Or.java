...
public class XCSP3Mini_Or extends XCallbacksDecomp {
    ...
    public static XCSP3LoadedInstance load(String filename) throws Exception {
        XCSP3Mini_Or xcsp3 = new XCSP3Mini_Or();
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // "minicsp24/HyperSudoku/HyperSudoku-mini-02_c24.xml"
        //
        ...
        instance.md().runCP((cp) -> {
            DFSearchMini_Or search = cp.dfSearchMini(branching);
//            search.onSolution(() -> {
//                System.out.print(q);
//            });
